...
# --- 3. 기후변화 대응 매개체 감시 (💡 요구사항: 모기는 춘천만, 참진드기는 화천/인제만 필터 격리 가동) ---
    ...
    if not m_data.empty:
        ...
        st.info(f"💡 선택하신 {selected_year} {selected_month} 기간의 [{selected_zone}] 지정 지점 관할 데이터가 존재하지 않습니다.")
